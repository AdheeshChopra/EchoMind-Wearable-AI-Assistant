...
export const ENV = {
  ...
  API_URL: process.env.EXPO_PUBLIC_API_URL || (global.__DEV__ ? DEV_API_URL : ''),
  WS_URL: process.env.EXPO_PUBLIC_WS_URL || (global.__DEV__ ? DEV_WS_URL : ''),
  IS_PROD: !global.__DEV__,
};
